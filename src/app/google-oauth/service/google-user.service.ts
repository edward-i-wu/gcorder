...
export class GoogleUserService {
  ...
  init() {
    ...
    //
    // // TODO ngZone?
    // const currentUser: Observable<gapi.auth2.GoogleUser> = this.googleAuthService.$.switchMap(googleAuth => {
    //   const user = googleAuth.currentUser.get();
    //   return !user ? Observable.never() : Observable.of(user);
    // });
    // const futureUsers: Observable<gapi.auth2.GoogleUser> = this.googleAuthService.$.switchMap(googleAuth => {
